...
export default function Home() {
  ...
  return (
    ...
    // </div>
    <div>
      <div className='min-h- bg-slate-300'>
        this is a test
      </div>
      <div class="h-1/2 w-full bg-slate-100 dark:bg-gray-100">
        <div class="h-full lg:w-[60%] sm:w-[80%] xs:w-[90%] mx-auto flex gap-8 items-center">
          <div
            class="flex flex-col gap-4 text-black dark:text-black p-4 rounded-lg border border-black-300 shadow-xl shadow-slate-400/30">
            <h5 class="text-sm text-black font-semibold">Korean American Society of Houston</h5>
            <div class="w-full flex gap-2 items-center justify-around">
              <div class="text-5xl font-semibold uppercase font-serif">Thank You</div>
              <hr class="w-[50%] h-1 rounded-full border-t-slate-500 bg-slate-500" />
            </div>
            <p class="text-sm">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget justo sit amet massa hendrerit bibendum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin.
            </p>
