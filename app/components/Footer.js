  ...
  return (
    <footer className="pb-4 px-3 bg-white border-t-2">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 gap-x-6 gap-y-2">
          {navLinks.map(({ label, href }) => (
            <li key={href}>
              <a href={href} className="duration-200 hover:text-kashBlue-400 hover:underline">
                {label}
              </a>
            </li>
          ))}
