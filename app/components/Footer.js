      ...
      <footer className="pb-2 px-3 bg-white border-t-2">
        <div className="mx-auto max-w-screen-xl text-center">
          ...
          <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900">
            ...
            <li><a href="/MentorshipProgram" className="mr-4 duration-200 hover:text-kashBlue-400 hover:underline md:mr-6 ">2025 Mentorship Program</a></li>
          ...
          <span className="text-sm text-gray-500 sm:text-center ">©2025 <a href="#" className="duration-200 hover:underline">The Korean American Society of Houston</a>. All Rights Reserved.</span>
        </div>
      </footer>
    </div>
  )
