...
export default function TeamMember({ name, title, description, image }) {
  return (
    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex mb-8 sm:mb-0">
      <a href="#">
        <img className="h-1/2 rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Benny side eye" />
      </a>
      <div className="p-5">
