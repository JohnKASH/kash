// Minimal, consistent line-icon set (stroke-based, 24px grid).
// Replaces the emoji previously used across the site for a cleaner,
// more professional look. Each icon inherits `currentColor`.
...
const Svg = ({ className = "w-6 h-6", children }) => (
...
export const Palette = (p) => (
  <Svg {...p}>
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.65-.75 1.65-1.69 0-.43-.18-.83-.44-1.12-.29-.29-.44-.65-.44-1.13a1.64 1.64 0 0 1 1.67-1.67h1.99c3.05 0 5.56-2.5 5.56-5.55C22 6.01 17.5 2 12 2z" />
  </Svg>
);
